...
if __name__ == '__main__':
    ...
    flux_model = pickle.load(open("Data/Intermediate/Experimentally_Aligned_Model/A549_RECON1.mdl", "rb"))
    ...
    saved_model = copy.deepcopy(pickle.load(open("Data/Intermediate/Experimentally_Aligned_Model/A549_RECON1.mdl", "rb")))
    Start = time.time()
    flush_count = 8
    ...
    with open("Data/Intermediate/Essential_Flux_Values/EF_A549_RECON1.json", "w") as EFO:
