...
t_start =time.time()
efl = flux_model.find_essential_fluxes_fast(seed=i)
...
if not works:
    ...
    with open("Data/Intermediate/Essential_Flux_Lists/exhauset_EF_A549_recon2_2_GLUN_and_SERtm_added_Error_List_test.txt", "a+") as EFO:
        EFO.write(str(efl)+f"\n{i, err_type}, seed = {i}, ps\n")
if works:
    with open("Data/Intermediate/Essential_Flux_Lists/exhaust_EF_A549_recon2_2_GLUN_and_SERtm_added_2.txt", "a+") as EFO:
        EFO.write(str(efl)+"\n")