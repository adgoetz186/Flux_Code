...
warmup = recon_flux_model.generate_warmup_gb_pinch_scan_br(10000,[1,2,4],5,'biomass_reaction', repeat_basis= 1,points_save_path = warmup_sample_location,model_save_path = HR_ready_model_location,trans_NS = trans_NS,rxn_scan= True)