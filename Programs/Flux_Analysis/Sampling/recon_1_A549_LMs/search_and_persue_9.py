...
list_of_reactions_to_opt = ['EX_lac_L(e)','EX_his_L(e)_inverted','EX_arg_L(e)_inverted','EX_asn_L(e)_inverted','EX_asp_L(e)','EX_cys_L(e)_inverted','EX_glu_L(e)']
...
all_LMs = np.array([-9.7,4.64148466,12.65320989,22.091782,2.50650002,38.89746144,-56.66662316])
all_alphas = np.ones(len(RPS_names))*1000
