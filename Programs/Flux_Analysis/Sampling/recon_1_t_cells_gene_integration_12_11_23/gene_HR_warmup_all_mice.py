...
# Finds random vertices in polytope for HR sampling, see readme.txt for suggestions for running
...
# Remove
Internal_nullspace_S = sio.loadmat(Path("Data/null_space_S/recon_1_t_cells_12_11_23/NS.mat"))['NS']
...
HR_ready_model_location = Path("Data/Models/json_models/fast_key_format/recon_1_t_cells_12_11_23/HR_Ready_Day_2_single_size")
