...
input_path = Path("Data/HR/HR_Points_analysis/recon_1b_t_cells_gene_Day_2/")
HR_model_location = Path("Data/Models/json_models/fast_key_format/recon_1b_t_cells/HR_ready_Day_2")
output_path = Path("Data/HR/HR_bi_directional_points/recon_1b_t_cells_gene_Day_2/")
...
for file_name in os.listdir(input_path):
	...
	print(np.shape(dtf.to_numpy()))
	np.save(output_path / (file_name.split("_")[0]), dtf.to_numpy())
