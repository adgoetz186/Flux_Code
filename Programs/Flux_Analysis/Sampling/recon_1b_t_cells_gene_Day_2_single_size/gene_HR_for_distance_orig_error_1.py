...
HR_model_location = Path("Data/Models/json_models/fast_key_format/recon_1b_t_cells/HR_Ready_Day_2_single_size_B6_1_sf")
warmup_sample_location = Path("Data/HR/HR_Warmup/recon_1b_t_cells_gene_Day_2_single_size_B6_1_sf")
HR_Points_location = Path("Data/HR/HR_Points_Distances/orig_recon_1b_t_cells_gene_Day_2_single_size_B6_1_sf_error_1")
...
for flux_model_name in flux_model_dict.keys():
	...
	# 100000, 500
	HR_samples = flux_model.HRSampler_2(warmup_dict[flux_model_name], 100000, 500)
