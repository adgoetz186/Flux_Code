...
warmup_sample_location = Path("Data/HR/HR_Warmup/recon_1b_t_cells_gene_Day_2_single_size_B6_1_A")
HR_Points_location_load = Path("Data/HR/HR_Points_Distances/recon_1b_t_cells_gene_Day_2_single_B6_1_gene_med_lin_comb_A_uni")
HR_Points_location = Path("Data/HR/HR_Points_Distances/recon_1b_t_cells_gene_Day_2_single_B6_1")
