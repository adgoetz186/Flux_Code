...
min_model_file_location = Path("Data/Models/json_models/fast_key_format/recon_1b_t_cells/pos_min_model_Day_2/")
output_file_location = Path("Data/Models/json_models/fast_key_format/recon_1b_t_cells/edited_pos_min_models_Day_2/")
...
for model in flux_model_list:
	...
	del model.model_dict["rxn_dict"]["H2O2syn"]
	input()
