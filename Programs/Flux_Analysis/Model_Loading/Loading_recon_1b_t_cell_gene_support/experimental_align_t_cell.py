...
Day = 2
ofp = Path(f"Data/Models/json_models/fast_key_format/recon_1b_t_cells/exp_aligned_Day_{Day}")
...
output_opt_data_file_location_b_dict = {i:cfp / mouse_number_filename_dict[i]/f"experimental_alignment_result_data_b_Day_{Day}" for i in mouse_number_filename_dict.keys()}
