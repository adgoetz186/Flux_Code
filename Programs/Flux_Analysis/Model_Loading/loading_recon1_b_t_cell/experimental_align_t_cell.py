...
for mouse_number in mouse_number_filename_dict.keys():
    ...
    experimental_measured_rates = Path(f"Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/Expt_Measured_Rates.csv")

    biomass_rates = Path(
        f"Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/Biomass_Data.csv")
    
    output_opt_data_file_location = Path(f"Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/experimental_alignment_result_data_a")
    
    cell_size_file = Path(f"Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/cell_size.txt")
    ...
    recon1_rxn_added.pinch_restricted_exchange_reactions(experimental_Allowed_Exchange_file_location, restore_essential=False,true_exchange_signifier="(e)")
...
for mouse_number in mouse_number_filename_dict.keys():
    ...
    experimental_Allowed_Exchange_file_location = Path(f"/Users/agoetz/PycharmProjects/pythonProject2/Flux_Code/Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/Allowed_Exchange_Reactions")
    
    experimental_measured_rates = Path(f"/Users/agoetz/PycharmProjects/pythonProject2/Flux_Code/Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/Measured_Rates.csv")
    
    output_model_file_location = Path(f"/Users/agoetz/PycharmProjects/pythonProject2/Flux_Code/Data/Models/pkl_models/recon1b_t_cell/exp_aligned/{mouse_number_filename_dict[mouse_number]}_exp_aligned")
    
    output_opt_data_file_location = Path(f"/Users/agoetz/PycharmProjects/pythonProject2/Flux_Code/Data/experimental_alignment_data/recon1b_t_cell/Individual_Mice/{mouse_number_filename_dict[mouse_number]}/experimental_alignment_result_data_b")
