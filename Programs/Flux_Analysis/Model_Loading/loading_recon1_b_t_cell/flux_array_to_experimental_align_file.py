...
ms_data = pd.read_csv(Path("Data/experimental_alignment_data/recon1_b_t_cell/Data_For_All_Mice/Expt_Met_Flux_Data.csv"))
bm_data = pd.read_csv(Path("Data/experimental_alignment_data/recon1_b_t_cell/Data_For_All_Mice/Biomass_Data.csv"))
cell_size_path = Path("Data/experimental_alignment_data/recon1_b_t_cell/Data_For_All_Mice/cell_size.txt")
Allowed_Exchange_Reactions_path = Path("Data/experimental_alignment_data/recon1_b_t_cell/Data_For_All_Mice/Allowed_Exchange_Reactions")
output_folder_dir = Path("Data/experimental_alignment_data/recon1_b_t_cell/Individual_Mice/")
