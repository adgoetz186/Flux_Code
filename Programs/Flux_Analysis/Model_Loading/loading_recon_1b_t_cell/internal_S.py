...
Internal_S_path = Path("Data/null_space_S/recon_1b_t_cells/pos_S_internal.mat")
...
#print(list(pos_S))
sio.savemat(Internal_S_path,{"S":test_bi_S})
print(np.shape(sla.null_space(test_bi_S)))
