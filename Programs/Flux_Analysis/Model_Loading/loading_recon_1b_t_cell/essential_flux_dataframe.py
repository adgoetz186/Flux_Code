...
output_model_folder = Path("Data/Minimal_Model_Data/recon_1b_t_cells/")
for filename in os.listdir(model_file_location):
	...
	start = time.time()
	recon1_exp_align.generate_essential_flux_dataframe(2,output_model_folder,recon1_exp_align.model_name+"_seed_1_dict_save_",print_progress = True,seed_name=True,seed_list=[1,2])