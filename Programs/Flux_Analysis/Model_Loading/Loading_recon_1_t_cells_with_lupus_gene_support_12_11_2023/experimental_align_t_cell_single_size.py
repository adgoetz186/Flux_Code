...
# Sets the size of the cell to be the optimal value found in the initial fit
...
Day = 2
ofp = Path(f"Data/Models/json_models/fast_key_format/recon_1_t_cells_12_11_23/exp_aligned_Day_{Day}_single_size")
if not os.path.exists(ofp):
	os.mkdir(Path(f"Data/Models/json_models/fast_key_format/recon_1_t_cells_12_11_23/exp_aligned_Day_{Day}_single_size"))
