...
mat_file_location = Path("Data/Models/mat_models/recon1_b.mat")


output_file_location = Path("Data/Models/pkl_models/recon1_b_t_cell/raw.pkl")
...
model_name_to_save = "model"

recon_flux_model = Flux_Balance_Model()
recon_flux_model.load_mat_model(mat_file_location,read_model_name=model_name_to_save,stored_model_name=model_name_to_save,model_comp=model_comp)
print(len(recon_flux_model.rxn_dict.keys()))
print(recon_flux_model.get_exchanged_reaction_info())
input()
