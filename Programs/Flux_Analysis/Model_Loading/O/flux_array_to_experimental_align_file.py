...
ms_data = pd.read_csv(Path("Data/experimental_alignment_data/recon1_b_t_cell/Data_For_All_Mice/Met_Flux_Data.csv"))
...
for mouse_number in mice_numbers:
	...
	reaction_list.append("biomass_reaction")
	value_list.append(mouse_data["Biomass"].to_numpy()[0])
	unit_list.append("mmol/(gDw*hr)")
