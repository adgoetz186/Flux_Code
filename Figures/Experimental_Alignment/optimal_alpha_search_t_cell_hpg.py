...
for mouse_number in mouse_number_filename_dict.keys():
    file_location = f"/Users/agoetz/PycharmProjects/pythonProject2/Flux_Code/Data/experimental_alignment_data/recon2_2_t_cell_hpg/{mouse_number_filename_dict[mouse_number]}/experimental_alignment_result_data.pkl"
